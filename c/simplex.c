/* simplex.c - Simplex Noise in 2D
 *
 * Stefan Gustavson's implementation, ported from Java to C.
...
typedef struct { double x, y, z, w; } Grad4;
...
static double F2, G2, F3, G3, F4, G4;
...
static double dot2(Grad3 *g, double x, double y)
{
	return g->x*x + g->y*y;
}

static double dot3(Grad3 *g, double x, double y, double z)
{
	return g->x*x + g->y*y + g->z*z;
}

static double dot4(Grad4 *g, double x, double y, double z, double w)
{
	return g->x*x + g->y*y + g->z*z + g->w*w;
}

// 2D simplex noise
static double noise2(double xin, double yin)
{
...
static double noise4(double x, double y, double z, double w)
{
...
/* Initialize */
/* NOTE: please call srand() before calling simplex_init() */
